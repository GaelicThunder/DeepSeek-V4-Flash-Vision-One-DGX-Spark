...
|---|---|
| **A+ with 26 promoted layers does not boot at 245k context** (`3.91 GiB KV cache is needed ... 0.63 GiB available`) | 22 layers at `UTIL=0.925` (KV 4.29 GiB); never raise `UTIL` above 0.93 on a 128 GB Spark (hard-lock) |
