...
# Placeholder text inlined at each image position; the multimodal processor
# expands it into the sentinel token block.
...
def flatten_content_blocks(content: Any) -> Any:
    ...
    data itself travels out of band (multi_modal_data) and is matched to the
