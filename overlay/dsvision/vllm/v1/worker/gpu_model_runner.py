...
class GPUModelRunner(
    ...
    def _build_attention_metadata(
        ...
        if self.is_mm_prefix_lm:
            ...
            # DeepSeek-V4 vision defines the bidirectional span over the whole
            # sentinel block ([IMAGE_START, IMAGE_END]) rather than the embed
            # tokens, and prepends a position-dependent alignment pad before the
            # first sentinel: derive the span from the full placeholder range and
            # strip that pad.
